  ...
  return (
     <div className="container p-5 mb-3 rounded-3 mt-1 header-container" >
      <div className="container py-5">
        <h1 className='display-5 fw-bold main-head text-light'>Order your favorite food here</h1>
        <p className='col-md-8 fs-4 text-white '>Discover the best food and drinks in Bengaluru</p>
